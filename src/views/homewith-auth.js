...
import './homewith-auth.css'

function HomewithAuth() {
  return (
    <div className="homewith-auth-container">
      <Helmet>
        <title>HomewithAuth - KamiAda</title>
        <meta property="og:title" content="HomewithAuth - KamiAda" />
      </Helmet>
      <div className="homewith-auth-hero">
        <div className="homewith-auth-bg"></div>
        <HeaderwithAuth rootClassName="headerwith-auth-root-class-name5"></HeaderwithAuth>
        <div className="homewith-auth-container1">
          <div className="homewith-auth-container2">
            <h1 className="homewith-auth-text">Your story starts with us.</h1>
            <span className="homewith-auth-text01">
              <span></span>
              <span>
                This is a simple example of a Landing Page you can build using
                KamiAda React. It features multiple CSS components based on
          ...
          <img
            alt="image"
            src="/gray-vector.svg"
            className="homewith-auth-image"
          />
          <img
            alt="image"
            src="/white-vector.svg"
            className="homewith-auth-image1"
          />
        </div>
      </div>
      <div className="homewith-auth-section1">
        <div className="homewith-auth-container3">
          <div className="homewith-auth-container4">
            <h6 className="homewith-auth-text04">
              <span>WITH BURNED SOLES</span>
              <span></span>
            </h6>
            <h3 className="homewith-auth-text07 Healine">
              I&apos;ve risen with the soles burned
            </h3>
            <span className="homewith-auth-text08 TextXL">
              <span className="homewith-auth-text09">
          ...
          <div className="homewith-auth-cards-container">
            <div className="homewith-auth-card1">
              <div className="homewith-auth-container5">
                <svg viewBox="0 0 1024 1024" className="homewith-auth-icon">
              ...
              <h6 className="homewith-auth-text10 TextXL">Awarded Agency</h6>
              <span className="homewith-auth-text11">
                Divide details about your product or agency work into parts. A
                paragraph describing a feature will be enough.
              </span>
            </div>
            <div className="homewith-auth-card2">
              <div className="homewith-auth-container6">
                <svg
                  viewBox="0 0 1097.142857142857 1024"
                  className="homewith-auth-icon2"
                >
              ...
              <h6 className="homewith-auth-text12 TextXL">Free Revisions</h6>
              <span className="homewith-auth-text13">
                Keep you user engaged by providing meaningful information.
                Remember that by this time, the user is curious.
              </span>
            </div>
            <div className="homewith-auth-card3">
              <div className="homewith-auth-container7">
                <svg viewBox="0 0 1024 1024" className="homewith-auth-icon4">
              ...
              <h6 className="homewith-auth-text14 TextXL">Verified Company</h6>
              <span className="homewith-auth-text15">
        ...
        <img
          alt="image"
          src="/white-vector.svg"
          className="homewith-auth-image2"
        />
      </div>
      <Footer></Footer>
    </div>
